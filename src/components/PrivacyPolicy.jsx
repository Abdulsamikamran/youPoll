...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <Container py={20} maxW={"1600px"} mx={"auto"}>
        <Box p={5}>
          <Heading as="h1" size="xl" mb={4} textAlign={"center"}>
            PRIVACY POLICY
          </Heading>
          <Text mb={10} fontSize={12} textAlign={"center"}>
            Updated at January 1st, 2025
          </Text>
          <Text mb={4}>
            Updated at January 1st, 2025 yupoll (“we,” “our,” or “us”) is
            committed to protecting your privacy. This Privacy Policy explains
            how your personal information is collected, used, and disclosed by
            yupoll. This Privacy Policy applies to our website, and its
            associated subdomains (collectively, our “Service”) alongside our
            application, yupoll. By accessing or using our Service, you signify
          ...
          <UnorderedList mb={4}>
            ...
            <ListItem>
              ...
              “we,” “us,” or “our,” it refers to yupoll, that is responsible for
            ...
            <ListItem>
              ...
              person that signs up to use the yupoll Service to manage the
            ...
            <ListItem>
              ...
              visit yupoll and use the services.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              ...
              employed by yupoll or are under contract to perform a service on
            ...
            <ListItem>
              <strong>Service:</strong> refers to the service provided by yupoll
            ...
            <ListItem>
              ...
              this URL:{" "}
              <Link href="https://yupoll.com/">https://yupoll.com/</Link>
            </ListItem>
            <ListItem>
          ...
          <Heading as="h2" size="lg" mb={2}>
            When does yupoll use end user information from third parties?
          </Heading>
          <Text mb={4}>
            yupoll will collect End User Data necessary to provide the yupoll
          ...
          <Heading as="h2" size="lg" mb={2}>
            When does yupoll use customer information from third parties?
          </Heading>
          <Text mb={4}>
            ...
            interest in becoming a yupoll customer, we receive information from
            a third party that provides automated fraud detection services to
            yupoll. We also occasionally collect information that is made
          ...
          <Text mb={4}>
            yupoll will collect personal information that you submit to us. We
          ...
          <Text mb={4}>
            ...
            yupoll to you and fulfill the purposes described in this policy.
          ...
          <Text mb={4}>
            ...
            information you transmit to yupoll or guarantee that your
          ...
          <Text mb={4}>
            yupoll is incorporated in united kingdom. Information collected via
          ...
          <Heading as="h2" size="lg" mb={2}>
            Is the information collected through the yupoll Service secure?
          </Heading>
          <Text mb={4}>
          ...
          <Text mb={4}>
            ...
            information yupoll collects depend on your relationship with yupoll.
          ...
          <Text mb={4}>
            ...
            all of the assets of yupoll or any of its Corporate Affiliates (as
            defined herein), or that portion of yupoll or any of its Corporate
          ...
          <Text mb={4}>
            ...
            control with yupoll, whether by ownership or otherwise. Any
          ...
          <Text mb={4}>
            ...
            laws of united kingdom, excluding its conflicts of law rules, shall
            ...
            international laws. By using yupoll or contacting us directly, you
            ...
            ```jsx , or use our services. Continued use of the website, direct
          ...
          <Text mb={4}>
            ...
            it's being used. By using our yupoll, registering an account, or
          ...
          <Text mb={4}>
            ...
            yupoll. We are not responsible for the content, accuracy or opinions
          ...
          <Text mb={4}>
            ...
            ("Third- Party Services"). You acknowledge and agree that yupoll
            ...
            yupoll does not assume and shall not have any liability or
          ...
          <Text mb={4}>
            ...
            the right thing to do. At yupoll we strongly believe that your data
          ...
          <Text mb={4}>
            ...
            rights requirements of GDPR. yupoll processes or stores all personal
          ...
          <UnorderedList mb={4}>
            <ListItem>
              Via Email:{" "}
              <Link href="mailto:james@yupoll.com">james@yupoll.com</Link>
            </ListItem>
          </UnorderedList>

          <Text mb={4}>Powered by TCPDF (www.tcpdf.org)</Text>
        </Box>
      </Container>
    </Layout>
  );
